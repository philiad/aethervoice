...
public class OneShotAlarm2 extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
    	...
    	if (SettingsWindow.connection == SettingsWindow.CONNECTION_WLAN ||
        		...
        		SettingsWindow.connection == SettingsWindow.CONNECTION_VPN ||
        		//PreferenceManager.getDefaultSharedPreferences(context).getBoolean(Settings.PREF_EDGE, Settings.DEFAULT_EDGE)) {
        		SettingsWindow.connection == SettingsWindow.CONNECTION_EDGE) {
